...
function SetupGuideBackdrop(props: { compact?: boolean }) {
  return (
    <>
      <div
        className={cn(
          'or-grid-bg bg-muted/25 pointer-events-none absolute inset-0',
          props.compact
      ...
      <div
        className='from-background/20 to-background/70 pointer-events-none absolute inset-0 bg-linear-to-b via-transparent'
        aria-hidden='true'
      />
    </>
  )
...
function StartStepItem(props: {
  ...
  return (
    <li className='relative flex gap-3 pb-2.5 last:pb-0'>
      ...
      <span
        className={cn(
          'bg-background relative z-10 flex size-8 shrink-0 items-center justify-center rounded-md border shadow-none',
      ...
      <Link
        to={props.step.to}
        className='bg-background/70 hover:bg-muted/50 focus-visible:ring-ring flex min-w-0 flex-1 items-center justify-between gap-3 rounded-lg border px-3 py-2.5 text-left shadow-none transition-colors outline-none focus-visible:ring-2'
      >
...
function RequestPreview(props: {
  ...
  return (
    <motion.div
      ...
      className='bg-background/75 relative overflow-hidden rounded-lg border p-3 shadow-none backdrop-blur'
    >
      {!shouldReduceMotion && (
        <motion.div
      ...
      <div className='bg-muted/30 my-3 rounded-lg border p-3 font-mono text-xs'>
      ...
      <div className='grid gap-2'>
        {props.signals.map((signal) => {
          ...
          return (
            <div
              key={signal.label}
              className='bg-muted/35 flex items-center justify-between gap-3 rounded-md border px-3 py-2'
            >
    ...
    <div className='flex flex-col gap-4'>
      {setupGuideExpanded ? (
        <CardStaggerContainer className='grid items-stretch gap-4 xl:grid-cols-[minmax(0,1fr)_22rem]'>
          <CardStaggerItem className='bg-card h-full overflow-hidden rounded-lg border shadow-none'>
          ...
          <CardStaggerItem className='bg-card h-full rounded-lg border p-4 shadow-none sm:p-5'>
        ...
        <CardStaggerContainer>
          <CardStaggerItem className='bg-card overflow-hidden rounded-lg border shadow-none'>
            <div className='relative overflow-hidden px-4 py-3 sm:px-5'>
              <SetupGuideBackdrop compact />
              <div className='relative flex flex-wrap items-center justify-between gap-3'>
                <div className='flex min-w-0 items-center gap-3'>
                  <span className='bg-background/70 flex size-9 shrink-0 items-center justify-center rounded-md border shadow-none'>
