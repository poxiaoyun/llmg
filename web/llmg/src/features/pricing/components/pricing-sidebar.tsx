...
function FilterChip(props: {
  ...
  return (
    <button
      ...
      className={cn(
        'group inline-flex max-w-full items-center gap-1.5 rounded-md border px-2 py-1 font-mono text-[11px] font-medium transition-colors',
        props.active
...
export function PricingSidebar(props: PricingSidebarProps) {
  ...
  return (
    <aside className={cn('or-surface p-3', props.className)}>
      <div className='mb-2.5 flex items-center justify-between gap-2'>
        <div>
          ...
          <p className='text-muted-foreground mt-1 text-xs'>
            {t('Refine models by provider and endpoint type.')}
          </p>
        </div>
        <Button
          type='button'
