...
export function SectionPageLayout(props: SectionPageLayoutProps) {
  ...
  return (
    <PageFooterProvider container={footerContainer}>
      <Main>
        <div className='bg-background/80 shrink-0 border-b px-3 pt-3 pb-3 backdrop-blur-xl sm:px-5 sm:pt-5 sm:pb-4'>
          {breadcrumb != null && (
        ...
        <div className='or-grid-bg min-h-0 flex-1 overflow-auto px-3 pt-3 pb-3 sm:px-5 sm:pt-4 sm:pb-5'>
          {content}
        </div>
