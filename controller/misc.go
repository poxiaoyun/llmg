...
func SendEmailVerification(c *gin.Context) {
	...
	if len(parts) != 2 {
		c.JSON(http.StatusOK, gin.H{
			"success": false,
			"message": i18n.T(c, i18n.MsgSettingEmailInvalid),
		})
		return
	}
	localPart := parts[0]
	...
	content := i18n.T(c, i18n.MsgEmailVerificationBody, templateData)
...
func SendPasswordResetEmail(c *gin.Context) {
	...
	if model.IsEmailAlreadyTaken(email) {
		...
		content := i18n.T(c, i18n.MsgPasswordResetBody, templateData)
		err := common.SendEmail(subject, email, content)
		if err != nil {
