...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			userRoute.POST("/wechat/notify", controller.WeChatPayNotify)
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.POST("/invoice", controller.CreateUserInvoiceRequest)
				selfRoute.POST("/invoice/lookup", controller.LookupUserInvoiceRequests)
				selfRoute.GET("/invoice/files/:id", controller.DownloadUserInvoiceFile)
			...
			adminRoute.Use(middleware.AdminAuth())
			{
				...
				adminRoute.GET("/invoice/requests", controller.GetAllInvoiceRequests)
				adminRoute.PUT("/invoice/requests/:id", controller.AdminUpdateInvoiceRequest)
				adminRoute.POST("/invoice/requests/:id/file", controller.AdminUploadInvoiceRequestFile)
				adminRoute.GET("/invoice/requests/:id/file", controller.AdminDownloadInvoiceFile)
